...
export async function getFarmBlockchainDetails({
  ...
  return {
    ...
    stakingToken,
    rewardRate: NormalizedNumber(rewardToken.fromBaseUnit(BaseUnitNumber(contractData.rewardRate))),
    periodFinish: Number(contractData.periodFinish),
    totalSupply: NormalizedNumber(stakingToken.fromBaseUnit(BaseUnitNumber(contractData.totalSupply))),
    earned: NormalizedNumber(rewardToken.fromBaseUnit(BaseUnitNumber(contractData.earned))),
    staked: NormalizedNumber(stakingToken.fromBaseUnit(BaseUnitNumber(contractData.staked))),
