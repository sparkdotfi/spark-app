...
export function useChartDetails(): ChartDetails {
  ...
  const result = useQuery({
    ...
    queryFn: () =>
      [
        {
          tvl: NormalizedNumber('482049675.184720652780565445'),
          apy: Percentage('0.08335185'),
        },
        {
          tvl: NormalizedNumber('478766313.752729727960766393'),
          apy: Percentage('0.08186471'),
        },
        {
          tvl: NormalizedNumber('481583088.354355862106449581'),
          apy: Percentage('0.08628850'),
        },
        {
          tvl: NormalizedNumber('487963328.654655159097482473'),
          apy: Percentage('0.08622413'),
        },
        {
          tvl: NormalizedNumber('483759723.985174605805184756'),
          apy: Percentage('0.08826929'),
        },
        {
          tvl: NormalizedNumber('400968869.291138141669247305'),
          apy: Percentage('0.10000869'),
        },
        {
          tvl: NormalizedNumber('396991464.562409324023704030'),
          apy: Percentage('0.09753633'),
        },
        {
          tvl: NormalizedNumber('388652195.071977090768933004'),
          apy: Percentage('0.10292583'),
        },
        {
          tvl: NormalizedNumber('342343826.577751461529530722'),
          apy: Percentage('0.11925978'),
        },
        {
          tvl: NormalizedNumber('343920926.910345115526662135'),
          apy: Percentage('0.11509350'),
        },
        {
          tvl: NormalizedNumber('326880028.481766269309190316'),
          apy: Percentage('0.12150797'),
        },
        {
          tvl: NormalizedNumber('324153495.281429066498019457'),
          apy: Percentage('0.11689703'),
        },
        {
          tvl: NormalizedNumber('242695988.420804765058078638'),
          apy: Percentage('0.15680931'),
        },
        {
          tvl: NormalizedNumber('132714478.540330764263189782'),
          apy: Percentage('0.28398774'),
        },
        {
          tvl: NormalizedNumber('29741295.986447529580084989'),
