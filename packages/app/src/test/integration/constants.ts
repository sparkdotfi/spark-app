...
export function getMockReserve(overrides: Partial<Reserve> = {}): Reserve {
  ...
  return {
    ...
    availableLiquidityUSD: NormalizedNumber(100 * priceInUsd),
    unborrowedLiquidity: NormalizedNumber(1000),
    supplyCap: undefined,
    totalLiquidity: NormalizedNumber(200),
    totalLiquidityUSD: NormalizedNumber(200 * priceInUsd),
    totalDebt: NormalizedNumber(100),
    totalDebtUSD: NormalizedNumber(100 * priceInUsd),
    totalVariableDebt: NormalizedNumber(100),
    totalVariableDebtUSD: NormalizedNumber(100 * priceInUsd),
    isolationModeTotalDebt: NormalizedNumber.ZERO,
    debtCeiling: NormalizedNumber(200),
    supplyAPY: Percentage(0.05),
    maxLtv: Percentage(0.8),
    liquidationThreshold: Percentage(0.8),
    liquidationBonus: Percentage(0.05),
    aTokenBalance: NormalizedNumber.ZERO,
...
export function getMockUserPosition(overrides?: Partial<UserPosition>): UserPosition {
  return {
    ...
    borrowBalance: NormalizedNumber.ZERO,
    collateralBalance: NormalizedNumber.ZERO,
    ...overrides,
  }
}
...
export function getMockMarketInfo(
  ...
  return new MarketInfo(
    ...
    nativeAssetInfo ?? {
      ...
      minRemainingNativeAssetBalance: NormalizedNumber(0.001),
    },
...
export const daiLikeReserve = getMockReserve({
  ...
  eModeCategory: undefined,
  isSiloedBorrowing: false,
  availableLiquidity: NormalizedNumber('24662247.809387867477416918'),
  availableLiquidityUSD: NormalizedNumber('24662247.809387867477416918'),
  totalLiquidity: NormalizedNumber('1022367834.197032800423989866'),
  totalLiquidityUSD: NormalizedNumber('1022367834.197032800423989866'),
  totalDebt: NormalizedNumber('997705586.387644932946572948'),
  totalDebtUSD: NormalizedNumber('997705586.387644932946572948'),
  totalVariableDebt: NormalizedNumber('997705586.387644932946572948'),
  totalVariableDebtUSD: NormalizedNumber('997705586.387644932946572948'),
  isolationModeTotalDebt: NormalizedNumber('0'),
  debtCeiling: NormalizedNumber('0'),
...
export const wethLikeReserve = getMockReserve({
  ...
  eModeCategory: undefined,
  isSiloedBorrowing: false,
  availableLiquidity: NormalizedNumber('125501.896724995390811222'),
  availableLiquidityUSD: NormalizedNumber('364885262.4790892529560601165'),
  totalLiquidity: NormalizedNumber('240005.463747054418237119'),
  totalLiquidityUSD: NormalizedNumber('697793889.34380830348699206054'),
  totalDebt: NormalizedNumber('114503.567022059027425897'),
  totalDebtUSD: NormalizedNumber('332908626.86471905053093194404'),
  totalVariableDebt: NormalizedNumber('114503.567022059027425897'),
  totalVariableDebtUSD: NormalizedNumber('332908626.86471905053093194404'),
  isolationModeTotalDebt: NormalizedNumber('0'),
  debtCeiling: NormalizedNumber('0'),
...
export function getMockTokenRepository(): TokenRepository {
  return new TokenRepository(
    [
      { token: testTokens.DAI, balance: NormalizedNumber(2000) },
      { token: testTokens.sDAI, balance: NormalizedNumber(2000) },
      { token: testTokens.USDS, balance: NormalizedNumber(500) },
      { token: testTokens.sUSDS, balance: NormalizedNumber(150) },
      { token: testTokens.USDC, balance: NormalizedNumber(400) },
    ],
    {
