...
import { NormalizedUnit } from '../types/NormalizedUnitNumber.js'
...
describe(bigNumberify.name, () => {
  ...
  it(`returns correct value for ${NormalizedUnit.name} arguments`, () => {
    expect(bigNumberify(NormalizedUnit(1))).toEqual(BigNumber(1))
  })
})
